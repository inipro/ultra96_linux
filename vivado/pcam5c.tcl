...
################################################################
# This is a generated script based on design: pcam5c
#
...
if { $list_projs eq "" } {
   create_project pcam5c pcam5c -part xczu3eg-sbva484-1-i
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins mipi_csi2_rx_subsyst_0/csirxss_s_axi]
  ...
  connect_bd_net -net clk_wiz_0_clk_300M [get_bd_pins clk_wiz_0/clk_300M] [get_bd_pins mipi_csi2_rx_subsyst_0/video_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins v_frmbuf_wr_0/ap_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins v_proc_ss_0/aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins rst_clk_wiz_0_300M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M02_ACLK]
  ...
  connect_bd_net -net rst_clk_wiz_0_300M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_300M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart0_rtsn [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_rtsn] [get_bd_ports BT_rtsn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins mipi_csi2_rx_subsyst_0/lite_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M00_ACLK]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_100M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_300M/ext_reset_in]
  ...
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs v_proc_ss_0/s_axi_ctrl/Reg] -force
